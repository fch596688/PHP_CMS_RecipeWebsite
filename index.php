...
<?php include "includes/navigation.php" ?>
    ...
    <?php        
        $query = "select r.recipe_id, r.recipe_title, r.recipe_date, r.recipe_description, r.recipe_image, u.username from recipe r, users u where r.recipe_status = 'published' and r.recipe_user_id = u.user_id";
    ...
    ?>
                ...
                <a class="btn btn-primary" href="view_recipe.php?recipe_id=<?php echo $recipe_id;?>">Read More<span class="glyphicon glyphicon-chevron-right"></span></a>  
       <?php }?>
                <hr>
                <!-- Pager -->
                <ul class="pager">
